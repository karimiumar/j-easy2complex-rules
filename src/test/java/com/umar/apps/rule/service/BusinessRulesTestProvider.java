...
public class BusinessRulesTestProvider {
    ...
    public static void createSomeRulesAndAttributes(RuleDao ruleDao, BusinessRuleService ruleService) {
        ...
        createAttribute(cptyNettingRule, "currency", "NETTING", "Currency", ruleService);
        createAttribute(cptyNettingRule, "settlementDate", "NETTING", "Settlement Date", ruleService);
    }
