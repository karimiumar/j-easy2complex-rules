...
public class AmountConditionService extends AbstractConditionService implements ConditionService {

    private static final Logger logger = LogManager.getLogger(AmountConditionService.class);

    protected AmountConditionService(){}

    @Inject
    public AmountConditionService(final RuleDao ruleDao) {
        super(ruleDao);
    }
