...
public class CounterPartyConditionService extends AbstractConditionService implements ConditionService {

    private static final Logger logger = LogManager.getLogger(CounterPartyConditionService.class);

    protected CounterPartyConditionService(){}

    @Inject
    public CounterPartyConditionService(final RuleDao ruleDao) {
        super(ruleDao);
    }
